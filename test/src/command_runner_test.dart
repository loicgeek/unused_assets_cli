...
import 'package:unused_assets_cli/src/command_runner.dart';
...
void main() {
  group('UnusedAssetsCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late UnusedAssetsCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = UnusedAssetsCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = UnusedAssetsCliCommandRunner();
